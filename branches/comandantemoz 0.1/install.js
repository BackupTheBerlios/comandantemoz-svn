...
var XpiInstaller = {
	...
	extFullName: 'ComandanteMoz', // The name displayed to the user (don't include the version)
	extShortName: 'comandantemoz', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.1',
	extAuthor: 'Javi y Julio',
